...
ALTER TABLE USER_T ADD(
NAME_TABLESPACE VARCHAR2(30 BYTE) NOT NULL,
CONSTRAINT TABLESPACE_FOREIGN_KEY FOREIGN KEY (NAME_TABLESPACE) REFERENCES TABLESPACE_T(NAME_TABLESPACE)
);
ALTER TABLE USER_T DROP
CONSTRAINT TABLESPACE_FOREIGN_KEY ;

ALTER TABLE TABLESPACE_T DROP COLUMN
NAME_TABLESPACE;
...
ALTER TABLE TABLESPACE_USER DROP
CONSTRAINT TABLESPACE_TABLESPACE_FOREIGN_KEY;

ALTER TABLE TABLESPACE_USER ADD(
CONSTRAINT TABLESPACE_USER_FOREIGN_KEY FOREIGN KEY (USER_ID) REFERENCES USER_T(USER_ID) ON DELETE CASCADE,
CONSTRAINT TABLESPACE_TABLESPACE_FOREIGN_KEY FOREIGN KEY (NAME_TABLESPACE) REFERENCES TABLESPACE_T(NAME_TABLESPACE) ON DELETE CASCADE
);
...
CONSTRAINT TABLESPACE_HISTORY_TABLESPACE_FOREIGN_KEY FOREIGN KEY (TABLESPACE_ID) REFERENCES TABLESPACE_T(NAME_TABLESPACE) ON DELETE CASCADE
);
...
CONSTRAINT DATAFILE_HISTORY_DATAFILE_FOREIGN_KEY FOREIGN KEY (DATAFILE_ID) REFERENCES DATAFILE_T(DATAFILE_ID) ON DELETE CASCADE
);
...
CONSTRAINT USER_HISTORY_USER_FOREIGN_KEY FOREIGN KEY (USER_ID) REFERENCES USER_T(USER_ID) ON DELETE CASCADE
);
...
USERNAME VARCHAR2(128 BYTE) NOT NULL,
CONSTRAINT SESSIONS_USER_FOREIGN_KEY FOREIGN KEY (USERNAME) REFERENCES USER_T(USER_ID)
);
...
CONSTRAINT SESSIONS_HISTORY_SESSIONS_FOREIGN_KEY FOREIGN KEY (SESSIONS_ID) REFERENCES SESSIONS(SESSIONS_ID) ON DELETE CASCADE
);
...
CONSTRAINT MEMORY_HISTORY_MEMORY_FOREIGN_KEY FOREIGN KEY (MEMORY_ID) REFERENCES MEMORY_T(MEMORY_ID)ON DELETE CASCADE
);
ALTER TABLE MEMORY_HISTORY DROP
CONSTRAINT MEMORY_HISTORY_MEMORY_FOREIGN_KEY;
ALTER TABLE MEMORY_HISTORY ADD(
CONSTRAINT MEMORY_HISTORY_MEMORY_FOREIGN_KEY FOREIGN KEY (MEMORY_ID) REFERENCES MEMORY_T(MEMORY_ID) ON DELETE CASCADE
);
