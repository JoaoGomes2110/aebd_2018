...
BEGIN
	...
	ELSIF UPDATING THEN
		...
		SET TIME_STAMP = CURRENT_TIMESTAMP, TABLESPACE_ID = :new.NAME_TABLESPACE , NAME_TABLESPACE=:new.NAME_TABLESPACE, SIZE_TABLESPACE=:new.SIZE_TABLESPACE, FREE_SPACE=:new.FREE_SPACE,USED=:new.USED,TYPE_TABLESPACE=:new.TYPE_TABLESPACE,MAX_SIZE=:new.MAX_SIZE,STATUS=:new.STATUS
